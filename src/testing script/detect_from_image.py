...
# ---- Paths ----
IMAGE_PATH = r"C:\Users\RUBESH\Desktop\RK Rough\Sem-7\velu model\test file\real_time_image\IMG20250620134106.jpg"              # <== change to your image file
MODEL_PATH = r"C:\Users\RUBESH\Desktop\RK Rough\Sem-7\velu model\best_model_fast.pth"     # your trained model
OUTPUT_PATH = r"C:\Users\RUBESH\Desktop\RK Rough\Sem-7\velu model\output\output.jpg"       # where to save result


# ---- Model definition (same as detect_from_video.py) ----
...
def main():
    ...
    face_image = pil_image.fromarray(cropped_face)
    ...
    cv2.rectangle(image, (x, y), (x+size, y+size), color, 25)
    text = f"{label}: {confidence:.2f}"
    cv2.putText(image, text, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 5, color, 10)
